...
var DateRangePanel = function (_PopperBase) {
  ...
  DateRangePanel.prototype.handleConfirm = function handleConfirm() {
    var _state5 = this.state,
        ...
        rangeState = _state5.rangeState;

    if (rangeState.selecting) {
      this.props.onPick([minDate, minDate], false);
    } else {
      this.props.onPick([minDate, maxDate], false);
    }
  };

  DateRangePanel.prototype.handleMouseLeavePanel = function handleMouseLeavePanel() {
    var _state6 = this.state,
        rangeState = _state6.rangeState,
        isInRange = _state6.isInRange;
  ...
  DateRangePanel.prototype.handleMouseEnterPanel = function handleMouseEnterPanel() {
    this.setState({
      isInRange: false
    });
  };
  ...
  DateRangePanel.prototype.render = function render() {
    ...
    var _state7 = this.state,
        ...
        minTimePickerVisible = _state7.minTimePickerVisible,
        maxTimePickerVisible = _state7.maxTimePickerVisible,
        minPickerWidth = _state7.minPickerWidth,
        maxPickerWidth = _state7.maxPickerWidth,
        isInRange = _state7.isInRange;
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: this.classNames('el-picker-panel__body', {
              'is-in-range': isInRange
            }), onMouseLeave: this.handleMouseLeavePanel.bind(this), onMouseEnter: this.handleMouseEnterPanel.bind(this) },
  ...
  _createClass(DateRangePanel, [{
    ...
    get: function get() {
      var _state10 = this.state,
          minDate = _state10.minDate,
          maxDate = _state10.maxDate,
          selecting = _state10.rangeState.selecting;
