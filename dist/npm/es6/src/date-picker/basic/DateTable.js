...
var DateTable = function (_Component) {
  ...
  DateTable.prototype.getStartDate = function getStartDate() {
    var ds = deconstructDate(this.props.isMultiple ? this.props.nowDate : this.props.date);
  ...
  DateTable.prototype.checkListHaveDate = function checkListHaveDate(dateList, currCell, isMultiple) {
  ...
  DateTable.prototype.handleClick = function handleClick(event) {
    ...
    var _deconstructDate = deconstructDate(lastDate),
